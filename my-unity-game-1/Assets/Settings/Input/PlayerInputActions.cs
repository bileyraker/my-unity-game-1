...
namespace Birdy
{
    ...
    ""controlSchemes"": [
        ...
        private IWorldCameraActions m_WorldCameraActionsCallbackInterface;
        ...
        public struct WorldCameraActions
        {
            ...
            {
                if (m_Wrapper.m_WorldCameraActionsCallbackInterface != null)
                {
                    @Pan.started -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnPan;
                    @Pan.performed -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnPan;
                    @Pan.canceled -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnPan;
                    @Zoom.started -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnZoom;
                    @Zoom.performed -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnZoom;
                    @Zoom.canceled -= m_Wrapper.m_WorldCameraActionsCallbackInterface.OnZoom;
